...
row handling area
'''
def aac_pssm(input_matrix):#checked
...
def d_fpssm(input_matrix):#checked
...
def smoothed_pssm(input_matrix, SMOOTH, SLIDE):#checked
...
def ab_pssm(input_matrix):#checked
...
def pssm_composition(input_matrix):#checked
...
def rpm_pssm(input_matrix):#checked
...
def s_fpssm(input_matrix):#checked
...
'''
column handling area
'''
def dpc_pssm(input_matrix):#checked
...
def k_separated_bigrams_pssm(input_matrix,STEP):#checked
...
def tri_gram_pssm(input_matrix):#checked
...
'''
mixture handling area
'''
def edp(input_matrix):#checked
...
def dp_pssm(input_matrix, ALPHA):#checked
...
def pssm_ac(input_matrix, GROUP):#checked
...
def pssm_cc(input_matrix, GROUP):#checked
